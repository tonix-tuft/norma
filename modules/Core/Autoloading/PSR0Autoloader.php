...
/**
 * PSR0Autoloader implementation that implements the technical interoperability
 ...
 *     $classLoader = new PSR0Autoloader('Doctrine\Common', '/path/to/doctrine');
...
class PSR0Autoloader {
    ...
    /**
     * Creates a new <tt>PSR0Autoloader</tt> that loads classes of the
     * specified namespace.
     *
